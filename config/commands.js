...
var commands = exports.commands = {
	...
	potd: function (target, room, user) {
		if (user.userid !== 'judgmental' && user.userid !== 'thaumicscrafty') return this.sendReply('The command \'/potd\' was unrecognized. To send a message starting with \'potd\', type \'//potd\'.');
	...
	if (!this.can('mute', null, room)) return false;
		...
		if (!this.canBroadcast()) return;
		 if (user.userid !== 'judgmental' && user.userid !== 'thaumicscrafty' && user.userid !== 'id0ntcare' && user.userid !== 'attempt999' && user.userid !== 'jason588') return this.sendReply('Your Not valid to make a lotto ticket.');
